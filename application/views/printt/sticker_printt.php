                    ...
                    <div class="form-panel">
                        ...
                        <div class="col-lg-5">
                                ...
                                <div class="col-sm-12">
                                    <select class="form-control" name="prefix">
                                        ...
                                        foreach ($get_prefix as $value) {
                                            ?>
                                            <option <?php if ($value->Prefix_Id == $this->session->userdata('pri_prefix')) { ?>selected="selected"<?php } ?>  value='<?php echo $value->Prefix_Id ?>'><?php echo $value->Prefix_Name ?></option>
                                            <?php
                                        }
                                        ?>
                                    </select>
                            ...
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" <?php if ($this->session->userdata('pri_radio_check') == 1) { ?>checked="checked"<?php } else {
                                            ?>checked = "checked"<?php }
                                        ?>  class="form-check-input" value="1" name="radio_check">Consignment No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                </label>
                                ...
                                <div class="col-sm-12">
                                    <select class="form-control" name="partyname" onchange='this.form.submit()'>
                                        ...
                                        foreach ($get_party as $value) {
                                            ?>
                                            <option <?php if ($value->Party_id == $this->session->userdata('pri_partyname')) { ?>selected="selected"<?php } ?>  value='<?php echo $value->Party_id ?>'><?php echo $value->Party_Name ?></option>
                                            <?php
                                        }
                                        ?>
                                    </select>
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" disabled="disabled" class="form-control"  value="<?php echo $pri_avail_qty; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-sm-12 col-sm-12 control-label">With Sticker</label>
                                <div class="col-sm-12">
                                    <input type="checkbox" name="withsticker" value="1" checked>
                                </div>
                            </div>
                        </div>
                    </div>

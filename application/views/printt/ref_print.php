                    ...
                    <div class="form-panel">
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" name="fromissue" placeholder="5-15 char" value="">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" name="toissue" placeholder="5-15 char" value="">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2">

                        ...
                        <div class="col-lg-5">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12s">
                                    <input type="text" tabindex=1 class="form-control" name="consignee_no" placeholder="5-15 char" value="<?php echo $this->session->userdata('chk_con_no'); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-5">
                        ...
                        <div class="form-panel">
                            ...
                            <div class="col-lg-5">
								...
								?>
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" tabindex=2 class="form-control" name="consignment_no" placeholder="3-25 char" value="<?php echo "VPL".($varaa + 1); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-12 col-sm-12 control-label"> Name </label>
                                    <div class="col-sm-12">
                                        <input type="text" tabindex=3 readonly class="form-control" name="consignee_name" placeholder="3-50 char" value="<?php
                                        if (is_array($consign_data)) {
                                            foreach ($consign_data as $value) {
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" tabindex=4 readonly class="form-control" name="address1" placeholder="3-25 char" value="<?php
                                        if (is_array($consign_data)) {
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" tabindex=5 readonly class="form-control" name="address2" placeholder="3-25 char" value="<?php
                                        if (is_array($consign_data)) {
                            ...
                            <div class="col-lg-5">
								...
								<div class="form-group">
                                    <label class="col-sm-12 col-sm-12 control-label"> Reference No</label>
                                    <div class="col-sm-12">
                                        <input type="text" tabindex=6 readonly class="form-control" name="reference_no" placeholder="3-25 char" value="<?php
                                        if (is_array($consign_data)) {
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" tabindex=7 readonly class="form-control" name="place" placeholder="3-25 char" value="<?php
                                        if (is_array($consign_data)) {
                                            //           echo str_replace('  ', '', $consign_data[0]->Consignee_Place);
                                            foreach ($consign_data as $value) {
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="number" tabindex=8 readonly class="form-control" name="pincode" placeholder="000000" value="<?php
                                        if (is_array($consign_data)) {
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" tabindex=9 readonly class="form-control" name="service" placeholder="3-25 char" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" tabindex=10 readonly class="form-control" name="weight" placeholder="0.00" value="<?php
                                        if (is_array($consign_data)) {
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" tabindex=11 readonly class="form-control" name="pieces" placeholder="123" value="<?php
                                               if (is_array($consign_data)) {

...
<html>
    ...
    <body>
        ...
        <h3>Place Master</h3>
        <br />
        <button class="btn btn-success" onclick="add_book()"><i class="glyphicon glyphicon-plus"></i> Add Place</button>
        <br />
        <br />
        <table id="table_id" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <?php foreach ($place as $book) { ?>
                    <tr>
                        <td><?php echo $book->Place_Code; ?></td>
                        <td><?php echo $book->Place_name; ?></td>
                        <td><?php echo $book->Place_off_address; ?></td>
                        <td><?php echo $book->Place_Contact; ?></td>
                        <td><?php echo $book->Place_Phone; ?></td>
                        <td>
                            <button class="btn btn-warning" onclick="edit_book(<?php echo $book->Place_Code; ?>)"><i class="glyphicon glyphicon-pencil"></i></button>
                            <button class="btn btn-danger" onclick="delete_book(<?php echo $book->Place_Code; ?>)"><i class="glyphicon glyphicon-remove"></i></button>
